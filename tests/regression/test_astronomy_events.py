...
from app.engine.cycle_engine import CycleEngine
from app.engine.event_engine import EventEngine
...
def test_jupiter_ingress_2024():
    ...
    t_ingress = datetime.fromtimestamp((ingress.julian_day - 2440587.5) * 86400.0, tz=UTC)
...
def test_mercury_station_2024():
    ...
    t_station = datetime.fromtimestamp((station.julian_day - 2440587.5) * 86400.0, tz=UTC)
...
def test_solar_return_2024():
    ...
    t_return = datetime.fromtimestamp((cycle_event.exact_time - 2440587.5) * 86400.0, tz=UTC)
